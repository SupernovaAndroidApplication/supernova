 ...
 */
public class CruiserBohregon extends MeshObject
{
    ...
    public CruiserBohregon(AssetManager am_)
    {
        am = am_;
        setVerts();
        setTexCoords();
    ...
    private void setVerts() {
        ...
        ModelLoader.loadContent(CRUISER_VERTS, "bohregon_cruiser_verts.txt", am);
    ...
    private void setTexCoords() {
        ...
        ModelLoader.loadContent(CRUISER_TEX_COORDS, "bohregon_cruiser_texCoords.txt", am);
    ...
    private void setNorms()
    {
        ...
        ModelLoader.loadContent(CRUISER_NORMS, "bohregon_cruiser_norms.txt", am);

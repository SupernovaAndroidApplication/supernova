 ...
 */
public class BomberYttrikt extends MeshObject
{
    ...
    public BomberYttrikt(AssetManager am_)
    {
        am = am_;
        setVerts();
        setTexCoords();
    ...
    private void setVerts() {
        ...
        ModelLoader.loadContent(BOMBER_VERTS, "yttrikt_bomber_verts.txt", am);
    ...
    private void setTexCoords() {
        ...
        ModelLoader.loadContent(BOMBER_TEX_COORDS, "yttrikt_bomber_texCoords.txt", am);
    ...
    private void setNorms()
    {
        ...
        ModelLoader.loadContent(BOMBER_NORMS, "yttrikt_bomber_norms.txt", am);

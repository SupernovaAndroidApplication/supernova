 ...
 */
public class FighterYttrikt extends MeshObject
{
    ...
    public FighterYttrikt(AssetManager am_)
    {
        am = am_;
        setVerts();
        setTexCoords();
    ...
    private void setVerts() {
        ...
        ModelLoader.loadContent(FIGHTER_VERTS, "yttrikt_fighter_verts.txt", am);
    ...
    private void setTexCoords() {
        ...
        ModelLoader.loadContent(FIGHTER_TEX_COORDS, "yttrikt_fighter_texCoords.txt", am);
    ...
    private void setNorms()
    {
        ...
        ModelLoader.loadContent(FIGHTER_NORMS, "yttrikt_fighter_norms.txt", am);

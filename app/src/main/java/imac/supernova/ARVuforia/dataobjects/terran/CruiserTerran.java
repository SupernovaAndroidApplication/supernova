 ...
 */
public class CruiserTerran extends MeshObject
{
    ...
    public CruiserTerran(AssetManager am_)
    {
        am = am_;
        setVerts();
        setTexCoords();
    ...
    private void setVerts() {
        ...
        ModelLoader.loadContent(CRUISER_VERTS, "terran_cruiser_verts.txt", am);
    ...
    private void setTexCoords() {
        ...
        ModelLoader.loadContent(CRUISER_TEX_COORDS, "terran_cruiser_texCoords.txt", am);
    ...
    private void setNorms()
    {
        ...
        ModelLoader.loadContent(CRUISER_NORMS, "terran_cruiser_norms.txt", am);
